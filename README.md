# starter-app-js-claude

A small AgentBox custom application: **JavaScript** + **@anthropic-ai/claude-agent-sdk**.
...
Listens on **8083**, declared in `agentbox-config.yaml`.
...
src/server.js          the routes
src/demos.js           the TrustGate and egress probes
